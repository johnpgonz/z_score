...
# Testing z_score function with all three populations and multiple uses cases: 
def test_case(pop):
...
The z-score of the least is:  -1.821218998013061
The z-score of the greatest is:  1.6467480771197802.

For this population: [-16, 10, -15, -6, -5, -20, -11, 9, -9, -7, 5, -14, 6, -10, -22, -19, 21, 11, -18, -13, -24, -21, 14, 19, 20, 13, 16, 8, 4, 3, 18, 22, 17, 7, -12, -3, 23, -8, 2, -2, -4, 1, 12, -25, -1, 15, 0, -23, -17, 24]
The z-score of the mean is:  0.0.
The z-score of the least is:  -1.697749375254331
The z-score of the greatest is:  1.697749375254331.

For this population: [125, 475, 275, 550, 350, 325, 575, 25, 225, 150, 425, 75, 175, 650, 600, 625, 675, 250, 100, 0, 375, 500, 400, 450, 300, 525, 50, 200]
The z-score of the mean is:  0.0.
